...
import '../yangi_sumkalar/yangi_sumlalar_barchasi.dart';

// ignore: must_be_immutable
class NewBags extends StatelessWidget {
  NewBags({super.key});
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (_) => const YangiSumkalarBarchasi()));
                  },
                  child: Text(
                    "Barchasi >",
                    style: GoogleFonts.poppins(
